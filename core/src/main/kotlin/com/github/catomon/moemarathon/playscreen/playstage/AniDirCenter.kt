...
class AniDirCenter(private val playScreen: PlayScreen) : Actor(), NoteListener {
    ...
    private val timingsCircleSprite = Sprite(assets.mainAtlas.findRegion("timings_circle"))
