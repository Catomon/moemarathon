...
class LoadingCover(labelText: String = "") : Widget() {
    ...
    private val cover = Sprite(assets.skinAtlas.findRegion("gui/white"))
    //private val icon = Sprite(assets.textureAtlas.findRegion("gui/loading"))
    private val animation = RegionAnimation(0.25f, assets.skinAtlas.findRegions("animated/loading"))
